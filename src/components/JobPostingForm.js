  ...
  return (
    <div className="container">
      ...
      <form>
        ...
        {/* Company industry */}
        <div className="form-group">
          <label htmlFor="companyIndustry" className="required-indicator">Company industry you are hiring for</label>
          <input type="text" id="companyIndustry" name="companyIndustry" value={form.companyIndustry} onChange={handleChange} placeholder="Add industry" required />
        </div>
        ...
        {/* Number of interview rounds and dynamic rounds */}
        <div className="form-group">
        ...
        {/* Questions for candidates (button only, logic can be added later) */}
        <div className="form-group">
          <label>Questions for candidates</label>
          <span className="sub-label">To better evaluate candidates, ask them questions regarding the job requirement</span>
          <button type="button" style={{ marginTop: 30 }}>+ Add a question</button>
        </div>
        {/* Company details */}
        ...
        <div className="button-group">
          <button type="submit">Preview & post job</button>
        </div>
      </form>
    </div>
  );
